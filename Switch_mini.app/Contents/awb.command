...
if [ -f "${BASE}"_1_"$date"_000070.dng ]
then
...
if [ -f "${BASE}"_1_"$date"_000140.dng ]
then
...
if [ -f "${BASE}"_1_"$date"_000200.dng ]
then
...
if [ -f "${BASE}"_1_"$date"_000250.dng ]
then
...
if [ -f "${BASE}"_1_"$date"_000310.dng ]
then
...
if [ -f "${BASE}"_1_"$date"_000390.dng ]
then
...
if [ -f "${BASE}"_1_"$date"_000450.dng ]
then
